...
// the on off button feed turns this LED on/off.  Arduino D5 is labeled as D2 on the EZSBC ESP-12 module.
#define LED 5
...
Adafruit_MQTT_Subscribe onoffbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/text01");
...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    ...
    if (subscription == &onoffbutton) {
      ...
      if (strcmp((char *)onoffbutton.lastread, "Black") == 0) {
